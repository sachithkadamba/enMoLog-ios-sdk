...
let ReachabilityChangedNotification = NSNotification.Name("RLReachabilityChangedNotification")

func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {

    guard let info = info else { return }
    
    let reachability = Unmanaged<RLReachability>.fromOpaque(info).takeUnretainedValue()
...
class RLReachability {

    typealias NetworkReachable = (RLReachability) -> ()
    typealias NetworkUnreachable = (RLReachability) -> ()
    ...
    fileprivate let reachabilitySerialQueue = DispatchQueue(label: "com.est.netowrkpingpong")
...
extension RLReachability {
    ...
    func startNotifier() throws {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<RLReachability>.passUnretained(self).toOpaque())
...
fileprivate extension RLReachability {
